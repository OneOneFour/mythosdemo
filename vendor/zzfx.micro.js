/* ZzFX - Zuper Zmall Zound Zynth - v1.3.2
   ...
   VENDORED, NOT A DEPENDENCY. Downloaded from
   raw.githubusercontent.com/KilledByAPixel/ZzFX/master/ZzFXMicro.min.js
   (1,222 bytes). The synthesis loop below is byte-identical to upstream.

   Exactly two edits were made, both marked inline:
     EDIT 1  `zzfxX=new AudioContext` -> `zzfxX=null`. Upstream builds the
             context at module load. Browsers require a user gesture first,
             and Node has no AudioContext at all — and tools/check.mjs
...
zzfxV=.3,               // volume
zzfxX=null,             // audio context, created lazily (EDIT 1)
zzfx=                   // play sound
...
||(b=C,u=G,n=n||1);X=zzfxX||(zzfxX=new AudioContext),p=X.createBuffer(1,h,R);p.getChannelData(0).set(k);b=X.
